...
@section('content')
  ...
  <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary rounded-2" tabindex="0">
    <!-- ===== ABOUT AREA STARTS ======= -->
    <div class="about1-section-area sp1" id="property">
    <div class="container">
    ...
    <!-- ===== SERVICE AREA STARTS ======= -->
    <div class="service1-section-area sp1" id="amenities">
    <div class="container">
      <div class="row">
      <div class="col-lg-4">
    ...
    <div class="apartment1-section-area sp2" id="apartment">
    <div class="container">
      <div class="row">
    ...
    <!-- ===== GALLERY AREA STARTS ======= -->
    <div class="gallery1-section-area" id="gallery">
    <div class="container">
      <div class="row">
    ...
    <div class="testimonial1-section-area sp1" id="testimonials">
    <div class="container">
      <div class="row">
      <div class="col-lg-5">
