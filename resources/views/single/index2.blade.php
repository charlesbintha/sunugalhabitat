...
@section('content')
  ...
  <div class="header-carousel-area2 owl-carousel">
    ...
    <div class="bg-elements">
      <img src="/img/elements/elements2.png" alt="" class="elements2" />
      <img src="/img/elements/elements2.png" alt="" class="elements3" />
    </div>
    <div class="container">
      <div class="row">
      <div class="col-lg-5">
  ...
  <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary rounded-2" tabindex="0">
    <!-- ===== ABOUT AREA STARTS ======= -->
    <div class="about2-section-area sp6" id="property">
    <div class="container">
      <div class="row">
      <div class="col-lg-5 m-auto">
        <div class="about-header text-center heading2 space-margin60">
    ...
    <div class="property2-section-area sp6">
    <div class="container">
      <div class="row">
      <div class="col-lg-12">
        <div class="property-header heading2 space-margin60">
        <div class="heading2">
    ...
    <!-- ===== SERVICE AREA STARTS ======= -->
    <div class="service2-section-area sp1" id="amenities">
    <div class="container">
      <div class="row">
      <div class="col-lg-6 m-auto">
        <div class="heading2 text-center">
        <h5>Villa amenities</h5>
        <div class="space20"></div>
    ...
    <!-- ===== GALLERY AREA STARTS ======= -->
    <div class="gallery2-section-area" id="gallery">
    <div class="container">
      <div class="row">
      <div class="col-lg-5 m-auto">
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-6">
          ...
          <div class="btn-area1" data-aos="fade-left" data-aos-duration="1200">
            <a href="{{ url('/pages/contact') }}" class="header-btn2">Schedule Visit Now</a>
          </div>
          </div>
        </div>
        <div class="col-lg-6">
    ...
    <!-- ===== CONTACT AREA STARTS ======= -->
    <div class="contact1-section-area sp5" id="contact">
    <div class="container">
      <div class="row">
      <div class="col-lg-5">
        <div class="heading2">
        ...
        <div class="space32"></div>
        <div class="btn-area1" data-aos="fade-left" data-aos-duration="1200">
          <a href="{{ url('/pages/contact') }}" class="header-btn2">Schedule A Consultation</a>
        </div>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        ...
        <div class="btn-area1">
          <a href="tel:+1(488)344-0117" class="header-btn2"><i class="fa-solid fa-phone-volume"></i> +1 (488) 344-0117</a>
    ...
    <!-- ===== BLOG AREA STARTS ======= -->
    <div class="blog-section-area sp7" id="blog">
    <div class="container">
      <div class="row">
      <div class="col-lg-5 m-auto">
    ...
    <!-- ===== FOOTER AREA STARTS ======= -->
    <div class="footer2-bottom-section">
    <div class="container">
      <div class="row">
      <div class="col-lg-12">
