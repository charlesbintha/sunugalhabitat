...
@section('content')
  ...
  <div class="header2-slick-slider">
    ...
    <div class="bg-img1">
      <video data-speed=".7" class="play-video" loop="" muted="" autoplay="" playsinline="" style=" scale: none; transform: translate(0px, 102.151px); will-change: transform;" data-lag="0">
  ...
  <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" class="scrollspy-example bg-body-tertiary rounded-2" tabindex="0">
    <!-- ===== ABOUT AREA STARTS ======= -->
    <div class="about7-section-area sp6" id="about">
    <div class="side-img">
    ...
    <div class="apartment7-area sp6" id="apartment">
    <div class="container">
      <div class="row">
      <div class="col-lg-6">
    ...
    <div class="container">
      ...
      <div class="col-lg-12">
        ...
        <div class="author-box" data-aos="zoom-in-up" data-aos-duration="800">
    ...
    <div class="property7-section-area sp6" id="property">
    <div class="container">
      <div class="row">
      <div class="col-lg-12">
    ...
    <div class="testimonial7-section-area sp1" id="testimonial">
    <div class="container">
      <div class="row">
    ...
    <!-- ===== CONTACT AREA STARTS ======= -->
    <div class="contact7-section-area sp5" id="contact">
    <div class="container">
      <div class="row">
      <div class="col-lg-5">
        <div class="heading2">
    ...
    <!-- ===== BLOG AREA STARTS ======= -->
    <div class="blog7-section-area sp7" id="blogs">
    <div class="container">
      <div class="row">
