  ...
  <div class="inner-main-hero-area">
    ...
    <div class="row">
      ...
      <div class="inner-heading header-heading">
        ...
        <p>
        <a href="{{ url('/') }}">Home <i class="fa-solid fa-angle-right"></i></a> <a href="{{ url('/apartment/v1') }}">Apartment V6</a>
        </p>
      </div>
      </div>
      ...
      <div class="apartment-featured-area" data-aos="zoom-in-down" data-aos-duration="800">
        ...
        <div class="col-lg-6 col-md-6">
          ...
          <div class="btn-area1">
            ...
            <div class="love">
            <a href="javascript:void(0)"><img src="/img/icons/heart11.svg" alt="" class="heart1" /><img src="/img/icons/heart12.svg" alt="" class="heart2" /></a>
            </div>
          </div>
          </div>
        </div>
