...
@section('content')
  ...
  <div class="apartment9-section-area sp6">
    <div class="container">
      <div class="row">
  ...
  <!-- ===== GALLERY AREA STARTS ======= -->
  <div class="gallery9-section-area sp6">
    <div class="container">
      <div class="row">
  ...
  <div class="testimonial9-area sp6">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 m-auto">
  ...
  <!-- ===== OTHERS AREA STARTS ======= -->
  <div class="others9-section-area sp6">
    <div class="container">
      <div class="row">
        <div class="col-lg-6 m-auto">
      ...
      <div class="row">
        ...
        <div class="col-lg-12" data-aos="zoom-in-up" data-aos-duration="1000">
          ...
          <div class="btn-area1 text-center">
            <a href="{{ url('/apartment/v1') }}" class="header-btn10"><i class="fa-brands fa-instagram"></i> Follow @hosue.property</a>
          </div>
        </div>
      </div>
    </div>
