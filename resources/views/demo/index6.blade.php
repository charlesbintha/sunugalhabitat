@extends('layouts.base', ['logo6' => true])

@section('body_attribute')
  class="homepage6-body"
@endsection
...
@section('content')
  ...
  <div class="header-slick-slider">
    ...
    <div class="bg-img1">
      <img src="/img/bg/header-bg1.png" alt="" />
    </div>
    <div class="container">
      <div class="row">
      <div class="col-lg-6">
        ...
        <div class="btn-area1">
          <a href="{{ url('/pages/contact') }}" class="header-btn7">Schedule A Visit <i class="fa-solid fa-arrow-right"></i></a>
        </div>
        </div>
      </div>
    ...
    <div class="hero6-main-area">
    <div class="bg-img1">
      <img src="/img/bg/header-bg2.png" alt="" />
    </div>
    <div class="container">
      <div class="row">
      <div class="col-lg-6">
    ...
    <div class="hero6-main-area">
    <div class="bg-img1">
      <img src="/img/bg/header-bg3.png" alt="" />
    </div>
    <div class="container">
      <div class="row">
      <div class="col-lg-6">
  ...
  <div class="slick-button-area d-flex">
    <div class="img1">
    <img src="/img/all-images/hero/hero-img10.png" alt="" />
    </div>

    <div class="img1">
    <img src="/img/all-images/hero/hero-img11.png" alt="" />
    </div>

    <div class="img1">
    <img src="/img/all-images/hero/hero-img12.png" alt="" />
    </div>
  ...
  <!-- ===== ABOUT AREA STARTS ======= -->
  <div class="about5-section-area sp6">
    <div class="side-img">
    <img src="/img/all-images/about/about-img9.png" alt="" data-aos="fade-up" data-aos-duration="1000" />
    </div>
    <div class="container">
    <div class="row">
      <div class="col-lg-12">
      <div class="service-images-area">
        ...
        <div class="col-lg-6">
          <div class="heading5 author-header heading6">
          ...
          <div class="others-area">
            ...
            <div class="box1" data-aos="fade-left" data-aos-duration="1050">
            <h2>3X</h2>
            <div class="space16"></div>
            <p>BathRoom</p>
            </div>

            <div class="box1" style="margin: 0;" data-aos="fade-left" data-aos-duration="1100">
            <h2>1X</h2>
            <div class="space16"></div>
            <p>Fitness Room</p>
            </div>
          ...
          <div class="list-area" data-aos="fade-left" data-aos-duration="1000">
            <ul>
            <li>
              <a href="#"><img src="/img/icons/check2.svg" alt="" /> ECO Construction</a>
            </li>
            <li>
              <a href="#"><img src="/img/icons/check2.svg" alt="" /> New Construction</a>
            </li>
            </ul>
            <ul>
            <li>
              <a href="#"><img src="/img/icons/check2.svg" alt="" /> Fitness Facilities</a>
            </li>
            <li>
              <a href="#"><img src="/img/icons/check2.svg" alt="" /> Swimming Pool</a>
            </li>
            </ul>
          </div>
  ...
  <div class="property6-author-section-area sp6">
    <div class="container">
    <div class="row">
      <div class="col-lg-12">
      <div class="property-header heading6 space-margin60">
        ...
        <div class="author-box" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="row">
      ...
      <div class="rotate-img">
        <iframe src="https://momento360.com/e/u/a8d9a4ad24e843f7bfa6372d83946bbb?utm_campaign=embed&utm_source=other&heading=0&pitch=0&field-of-view=75&size=medium&display-plan=true"></iframe>
      </div>
      </div>
      <div class="col-lg-4">
    ...
    <div class="row">
      ...
      <div class="apartment-featured-area" data-aos="zoom-in-down" data-aos-duration="800">
        ...
        <div class="col-lg-6 col-md-6">
          ...
          <div class="btn-area1">
            ...
            <a href="#" class="header-btn7">$820,000</a>
            </div>
            <div class="love">
            <a href="javascript:void(0)"><img src="/img/icons/heart3.svg" alt="" class="heart1" /><img src="/img/icons/heart4.svg" alt="" class="heart2" /></a>
            </div>
          </div>
          </div>
        </div>
      ...
      <div class="apartment-featured-area" data-aos="zoom-in-down" data-aos-duration="1000">
        ...
        <div class="col-lg-6 col-md-6">
          ...
          <div class="btn-area1">
            <div class="single-btn">
            <a href="#" class="header-btn7">$921,000</a>
            </div>
            <div class="love">
            <a href="javascript:void(0)"><img src="/img/icons/heart3.svg" alt="" class="heart1" /><img src="/img/icons/heart4.svg" alt="" class="heart2" /></a>
            </div>
      ...
      <div class="apartment-featured-area" data-aos="zoom-in-down" data-aos-duration="1200">
        ...
        <div class="col-lg-6 col-md-6">
          ...
          <div class="btn-area1">
            <div class="single-btn">
            <a href="#" class="header-btn7">$665,000</a>
            </div>
            <div class="love">
            <a href="javascript:void(0)"><img src="/img/icons/heart3.svg" alt="" class="heart1" /><img src="/img/icons/heart4.svg" alt="" class="heart2" /></a>
            </div>
  ...
  <div class="property6-section-area sp6">
    <div class="container">
    <div class="row">
      <div class="col-lg-12">
      <div class="row align-items-center">
        <div class="col-lg-6">
        <div class="property-header heading6">
          ...
          <div class="space32"></div>
          <div class="btn-area1" data-aos="fade-left" data-aos-duration="1200">
          <a href="{{ url('/pages/contact') }}" class="header-btn7">Schedule Visit Now <i class="fa-solid fa-arrow-right"></i></a>
          </div>
        </div>
        </div>
        <div class="col-lg-6">
        <div class="property-images">
          ...
          <div class="elements">
          <img src="/img/elements/elements10.png" alt="" />
          </div>
        </div>
        </div>
      </div>
  ...
  <div class="testimonial6-section-area sp1">
    ...
    <div class="row">
      <div class="col-lg-5">
      <div class="testimonial-header space-margin60 heading6">
      ...
      <div class="testimonialmain-slider">
        ...
        <div class="col-lg-7">
          ...
          <div class="testimonial-box">
            <img src="/img/icons/quoto-icon4.svg" alt="" />
            <div class="space16"></div>
  ...
  <!-- ===== BLOG AREA STARTS ======= -->
  <div class="blog6-section-area sp7">
    <div class="container">
    <div class="row">
      <div class="col-lg-5 m-auto">
      <div class="blog-header text-center heading6 space-margin60">
  ...
  <div class="footer6-section-area">
    ...
    <div class="row">
      ...
      <div class="footer-instagram-area">
        ...
        <div class="col-lg-6" data-aos="fade-left" data-aos-duration="1000">
          ...
          <div class="row">
            ...
            <div class="input-area text-end">
              <button type="submit" class="header-btn7">Send Message <i class="fa-solid fa-arrow-right"></i></button>
            </div>
            </div>
          </div>
          </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="row">
            <div class="col-lg-5 col-md-6" data-aos="zoom-in-down" data-aos-duration="800">
            ...
            <div class="col-lg-7 col-md-6" data-aos="zoom-in-down" data-aos-duration="900">
            <div class="instagram-posts">
              <div class="img1">
            ...
            <div class="col-lg-7 col-md-6" data-aos="zoom-in-down" data-aos-duration="1000">
            <div class="instagram-posts">
              <div class="img1">
            ...
            <div class="col-lg-5 col-md-6" data-aos="zoom-in-down" data-aos-duration="1200">
            <div class="instagram-posts">
              <div class="img1">
    ...
    <div class="space40"></div>
    <div class="footer6-bottom-section">
    <div class="container">
      <div class="row">
      <div class="col-lg-12">
