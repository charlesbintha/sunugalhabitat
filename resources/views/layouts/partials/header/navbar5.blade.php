                                                ...
                                                <div class="all-images-menu">
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/') }}">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index1') }}" target="_blank">One Page</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index2') }}"> Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index2') }}" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index3') }}">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index3') }}" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index4') }}">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index4') }}" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb" style="margin: 0;">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index5') }}">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index5') }}" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                ...
                                                <div class="all-images-menu">
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index6') }}">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index6') }}" target="_blank">One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index7') }}"> Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index7') }}" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index8') }}">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index8') }}" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index9') }}">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index9') }}" target="_blank"> One Page </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb" style="margin: 0;">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn6" href="{{ url('/demo/index10') }}">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn6" href="{{ url('/single/index10') }}" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
